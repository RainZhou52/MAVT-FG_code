...
from model.MAVT_FG import MAVT_FG_mm
...
def main(args):
    ...
    model = MAVT_FG_mm(args, num_classes=30, has_logits=False).to(device)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--video_data-path', type=str,
                        default="./dataset/FGB-AV/video")
    # audio path
    parser.add_argument('--audio_data-path', type=str,
                        default="./dataset/FGB-AV/audio")

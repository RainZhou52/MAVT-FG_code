...
def train_one_epoch(args,model, optimizer, data_loader, device, epoch, loss_weight=1.):
    recall = torchmetrics.Recall(average='none', num_classes=args.num_classes)
    precision = torchmetrics.Precision(average='none', num_classes=args.num_classes)
    f1 = torchmetrics.F1Score(average='none', num_classes=args.num_classes)
...
@torch.no_grad()
def evaluate(args,model, data_loader, device, epoch, loss_weight=1.):
    recall = torchmetrics.Recall(average='none', num_classes=args.num_classes)
    precision = torchmetrics.Precision(average='none', num_classes=args.num_classes)
    f1 = torchmetrics.F1Score(average='none', num_classes=args.num_classes)
